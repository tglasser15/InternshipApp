...
<h3> User Notes</h3>
<i>This is a currently active project and will be a continued project as part of the Mobile App Development course I am currently taking. <underline>Some of the features of the project are unusable as of 3/28/14.</underline> The project will be repeatedly updated over the course of the next two months, the ending of the course. <br>
...
<li><b>Run the simulator</b>You should have access to all the features of the app, besides the pages that are under maintenance.</li>
</ul>
